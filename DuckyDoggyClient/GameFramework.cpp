...
void CGameFramework::BuildObjects()
{
	...
	// 도기 생성
	m_pDoggy = new CTerrainPlayer(m_pd3dDevice, m_pd3dCommandList, m_pScene->GetGraphicsRootSignature(),"Model/Mydog.bin", PLAYER_KIND_DOGGY , true, m_pScene->m_pTerrain );
