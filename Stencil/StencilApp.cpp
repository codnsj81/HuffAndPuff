...
private:
	...
	XMFLOAT3 mSkullTranslation = { 0.0f, 0.5f, 0.0f };
...
void StencilApp::BuildMaterials()
{
	...
	skullMat->DiffuseAlbedo = XMFLOAT4(Colors::Yellow);
...
void StencilApp::BuildRenderItems()
{
	...
	skullRitem->Geo = mGeometries["BoxGeo"].get();
	skullRitem->PrimitiveType = D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST;
	skullRitem->IndexCount = skullRitem->Geo->DrawArgs["box"].IndexCount;
	...
	*shadowedSkullRitem = *skullRitem;
	shadowedSkullRitem->ObjCBIndex = 2;
